...
public class UnrepeatableAdapter extends RecyclerView.Adapter<UnrepeatableAdapter.ProgramViewHolder> {
    ...
    // CONSTRUCTOR
    UnrepeatableAdapter(ArrayList<Program> programList) {
        ...
        programViewHolder.programTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isViewExtended) {
                    ...
                    programViewHolder.price.setVisibility(View.VISIBLE);
                    programViewHolder.priceTitle.setVisibility(View.VISIBLE);
    ...
    public void onBindViewHolder(
        ...
        programViewHolder.price.setText(programItem.getPrice());
        }
